        ...
        <div className="main w-full rotate-[-10deg] scale-[1.7]">
          <div className="landing overflow-hidden relative w-full h-screen bg-black">
            ...
            <div className="imagesdiv relative overflow-hidden w-full h-screen">
              ...
              <img
                className="absolute character -bottom-[150%] mb-60 left-1/2 -translate-x-1/2  scale-[3] rotate-[-20deg]"
                src="./manpotrait-removebg-preview.png"
                alt=""
              />
            </div>
          ...
          <div className="w-full h-screen flex items-center justify-center bg-black">
            <div className="cntnr flex text-white w-full h-[80%] ">
              ...
              <div className="rg w-[30%] py-30">
                ...
                <p className="mt-10  text-yellow-500 text-xl font-[Helvetica_Now_Display]">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. At
                  eius illum fugit eligendi nesciunt quia similique velit
                  excepturi soluta tenetur illo repellat consectetur laborum
                  eveniet eaque, dicta, hic quisquam? Ex cupiditate ipsa nostrum
                ...
                <button className="bg-yellow-500 px-10 py-10 text-black  text-4xl">
                  Download Now 
                </button> 
